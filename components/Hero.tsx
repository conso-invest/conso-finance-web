    ...
    return (
        <div className="flex flex-col lg:flex-row justify-between items-center py-4 px-4 pt-28 lg:pt-32 lg:px-20 bg-blue-100">
            <div className="w-full lg:w-3/4">
                <h1 className="text-3xl lg:text-6xl font-extrabold leading-tight">Donnez des ailes <br /> <span style={{color:"#cdaa4b"}}> aux bonnes idées</span></h1>
            ...
            <div className="mt-10 lg:w-3/6 relative">
                <img alt="banner" src="https://images.ctfassets.net/guty4ttb9vho/4DWq49imTfQHjiqatiKRo0/b722cd17c2aaf27f92e39b35f2d12626/fany-africa-blossom.png?w=1020&q=100&fm=webp"></img>
